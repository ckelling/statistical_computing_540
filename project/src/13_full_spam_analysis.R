...
theta_av_df <- cbind(c(rep("nadam_nobc", 2*nrow(theta_av))),
...
#sgd
#save(s_store,file = "C:/Users/ckell/OneDrive/Penn State/2017-2018/01_Spring/540/statistical_computing_540/project/data/spam_full_sgd_sim.Rdata")
#save(s_storage_df, file = "C:/Users/ckell/OneDrive/Penn State/2017-2018/01_Spring/540/statistical_computing_540/project/data/spam_sgd_df.Rdata")
#sgd with momentum
